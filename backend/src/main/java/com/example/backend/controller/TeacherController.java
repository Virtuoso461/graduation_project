...
public class TeacherController {
    ...
    @Autowired
    public TeacherController(UserService userService, ProfileService profileService) {
    ...
    public Result<LoginVO> login(@RequestBody LoginDTO loginDTO) {
        ...
        if (loginVO.getRole() != Role.TEACHER) {
            return Result.forbidden("非教师账号，无法登录");
        }
    ...
    public Result<String> register(@RequestBody User user) {
        try {
            String register = userService.registerTeacher(user);
